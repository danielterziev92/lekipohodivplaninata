...
from lekipohodivplaninata.base.views import IndexListView, UpcomingEventListView, PassedEventListView, SignUpHike, \
    SiteEvaluationView, SignedForHikeListView, SignedForHikeUpdateView
...
urlpatterns = (
    ...
    path('recorded/<int:pk>/', include([
        path('edit/', SignedForHikeUpdateView.as_view(), name='signed for hike update'),
        # path('done/', ),
    ])),
