...
urlpatterns = (
    ...
    path('unsubscribe/<slug:slug>/', UnsubscribeView.as_view(), name='unsubscribe'),
    path('mailbox', MailboxTemplateView.as_view(), name='mailbox'),
